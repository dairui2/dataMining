...
for i, v in enumerate(center_num):
    ...
    plt.title('客户各聚类类别特征图',y=1.0, fontproperties="Arial Unicode MS", fontsize=14)                          #添加标题
    ax.grid()                                                        #添加网格线
    ...
    plt.savefig('./data/客户各聚类类别特征图', dpi=128, bbox_inches='tight')                    #保存图形，指定bbox_inches来裁剪图形多余空白区域
